...
class DataManager {
  ...
  InventoryTableDataProvider get inventoryTableDataProvider =>
      _getOrCreateProvider(DataProviderType.inventoryTable) as InventoryTableDataProvider;
  ...
  DataProvider _getOrCreateProvider(DataProviderType type) {
    ...
    switch (type) {
      ...
      case DataProviderType.inventoryTable:
        return InventoryTableDataProvider(networkClient: _networkClient);
      default:
